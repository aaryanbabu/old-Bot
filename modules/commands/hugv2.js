...
module.exports.onLoad = async() => {
    ...
    if (!existsSync(path)) await downloadFile("https://i.imgur.com/wDfTCkh.jpg", path);
}
...
async function makeImage({ one, two }) {
    ...
    batgiam_img.composite(circleOne.resize(70, 70), 370, 40).composite(circleTwo.resize(70, 70), 330, 150);
